  ...
  return (
    <main className="p-8 max-w-3xl mx-auto">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-2">Featured Documents & Tools</h2>
        <ul className="list-disc pl-6">
          ...
          <li>
            <Link href="/elevator_pitch_format.html" target="_blank" className="text-blue-600 underline">
