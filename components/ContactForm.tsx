...
<li className="flex items-center gap-2"><Mail className="h-4 w-4"/> hello@hucrafts.com</li>
<li className="flex items-center gap-2"><MapPin className="h-4 w-4"/> Bay Area, CA</li>
<li className="flex items-center gap-2"><Github className="h-4 w-4"/> github.com/vhu</li>
<li className="flex items-center gap-2"><Linkedin className="h-4 w-4"/> linkedin.com/in/vincenthu</li>
</ul>
</div>
